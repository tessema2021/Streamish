    ...
    public class VideoRepository : BaseRepository, IVideoRepository
    {
        ...
        public Video GetById(int id)
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"
                            SELECT v.Id videoId, v.Title, v.Description, v.Url, v.DateCreated, v.UserProfileId, up.Id as userId, 
                                   up.DateCreated as UserProfileDateCreated, up.Email, up.Name, up.ImageUrl as UserProfileImageUrl
                            FROM Video v
